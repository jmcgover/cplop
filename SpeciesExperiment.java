...
public class SpeciesExperiment implements Experiment, Serializable{
   int[] k;
   double[] alpha;
   ...
   public SpeciesExperiment(int k, double alpha, Phylogeny tree){
      this.k = new int[1];
      this.k[0] = k;
   ...
   public void runExperiment(){
      Filter<Pyroprint> filter = new EnvironmentalFilter();
      Species result = null;
...
//                        System.out.println("FALSE");
   ...
   public static SpeciesExperiment load(String experimentFilename){
      SpeciesExperiment experiment = null;
      ...
      if (obj instanceof SpeciesExperiment) {
         experiment = (SpeciesExperiment)obj;
      }
      else {
         throw new ClassCastException( "Your file '" + experimentFilename + "' was not a SpeciesExperiment object.\n");
      }
      return experiment;
   }
