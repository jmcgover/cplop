...
public class TreeBuilder{
    ...
    public Phylogeny build(Boolean filterIsolates, Collection<String> isolateIDs){
        ...
        Set<String> isolateIDFilterSet = null;
        if (filterIsolates) {
            isolateIDFilterSet = new HashSet<String>(isolateIDs);
        }
        ...
        try{
            if (allResults.first()) {
                do{
                    ...
                    if (filterIsolates) {
                        if (isolateIDFilterSet.contains(isol.getIsoId())) {
                            tree.add(spec);
                            tree.add(host);
                            tree.add(isol);
                            tree.add(pyro);
