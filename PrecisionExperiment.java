...
public class PrecisionExperiment 
   ...
   public PrecisionExperiment(int k, double alpha, Phylogeny tree){
      this.k = new int[1];
      this.k[0] = k;
...
//                        currAcc.addNonDecision();
                        ...
                        currAcc = testAccuracies[i][a].getProperAccuracy(result, p.getAppliedRegion());
   ...
   public static PrecisionExperiment load(String experimentFilename){
      PrecisionExperiment experiment = null;
      ...
      if (obj instanceof PrecisionExperiment) {
         experiment = (PrecisionExperiment)obj;
      }
      else {
         throw new ClassCastException( "Your file '" + experimentFilename + "' was not a PrecisionExperiment object.\n");
      }
      return experiment;
   }
